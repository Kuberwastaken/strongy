...
public class CustomThemePanel extends ThemePanel {
	...
	public CustomThemePanel(StyleManager styleManager, StrongyPreferences preferences, JFrame owner, CustomTheme theme, ActionListener deleteAction) {
	...
	private void editTheme(StyleManager styleManager, StrongyPreferences preferences, JFrame owner, CustomTheme theme) {
