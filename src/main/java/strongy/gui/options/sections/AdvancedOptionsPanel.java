...
import strongy.gui.components.preferences.DoublePreferencePanel;
...
public class AdvancedOptionsPanel extends JPanel {
	...
	public AdvancedOptionsPanel(StyleManager styleManager, StrongyPreferences preferences, ICalibratorFactory calibratorFactory, IActionExecutor actionExecutor, JFrame owner, DisposeHandler disposeHandler) {
