...
import strongy.gui.components.panels.HorizontalRestrictedThemedPanel;
import strongy.gui.components.panels.ThemedPanel;
import strongy.gui.options.CustomThemePanel;
import strongy.gui.options.ThemePanel;
import strongy.gui.options.ThemedScrollPane;
...
public class ThemeSelectionPanel extends ThemedPanel {
	...
	public ThemeSelectionPanel(StyleManager styleManager, StrongyPreferences preferences, JFrame owner) {
		super(styleManager);
	...
	private void populateThemesPanel(StyleManager styleManager, StrongyPreferences preferences, JFrame owner) {
	...
	private void createNewTheme(StyleManager styleManager, StrongyPreferences preferences, JFrame owner) {
		Theme.createCustomTheme(preferences);
		populateThemesPanel(styleManager, preferences, owner);
		styleManager.init();
	}

	private void deleteTheme(StyleManager styleManager, StrongyPreferences preferences, JFrame owner, CustomTheme theme) {
