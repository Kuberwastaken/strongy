...
import strongy.gui.components.labels.ColorMapLabel;
import strongy.gui.components.labels.ColoredLabel;
import strongy.gui.components.labels.ILabel;
...
public class ChunkPanel extends ThemedPanel implements IDisposable {
	...
	public ChunkPanel(StyleManager styleManager, StrongyPreferences preferences) {
		this(styleManager, preferences, null);
	}

	public ChunkPanel(StyleManager styleManager, StrongyPreferences preferences, ChunkPrediction p) {
		super(styleManager);
