...
import strongy.event.IObservableList;
...
import strongy.model.datastate.endereye.EnderEyeThrowType;
...
public class ThrowPanel extends ThemedPanel implements IDisposable {
	...
	public ThrowPanel(StyleManager styleManager, IDataState dataState, IButtonInputHandler buttonInputHandler, IObservable<ChunkPrediction> topResult, int index, Runnable whenVisibilityChanged, StrongyPreferences preferences) {
		super(styleManager);
		this.index = index;
