...
import strongy.gui.components.inputfields.LimitedThemedTextField;
import strongy.gui.components.inputfields.ThemedTextField;
...
import strongy.gui.themeeditor.PreviewButtonInputHandler;
import strongy.gui.themeeditor.PreviewCalculatorResult;
import strongy.gui.themeeditor.PreviewDataState;
import strongy.gui.themeeditor.PreviewUpdateChecker;
import strongy.gui.themeeditor.ThemeSerializer;
import strongy.gui.themeeditor.panels.ColorPickerPanel;
import strongy.gui.themeeditor.panels.ConfigurableColorPanel;
import strongy.gui.themeeditor.panels.FramePreviewPanel;
...
import strongy.model.datastate.endereye.NormalEnderEyeThrow;
...
public class ThemeEditorDialog extends ThemedDialog {
	...
	public ThemeEditorDialog(StyleManager styleManager, StrongyPreferences preferences, JFrame owner, CustomTheme customTheme) {
	...
	private ThemedPanel createPreviewsPanel(StyleManager styleManager) {
		...
		StrongyPreferences defaultPreferences = new StrongyPreferences(new UnsavedPreferences());
		...
		StrongyPreferences previewPreferences1 = new StrongyPreferences(new UnsavedPreferences());
		...
		ninBotPreviewBasic = new FramePreviewPanel(new StrongyFrame(previewStyleManager, previewPreferences1, new PreviewUpdateChecker(), dataState1, new PreviewButtonInputHandler(), new InformationMessageList()));

		StrongyPreferences previewPreferences2 = new StrongyPreferences(new UnsavedPreferences());
		...
		ninBotPreviewDetailed = new FramePreviewPanel(new StrongyFrame(previewStyleManager, previewPreferences2, new PreviewUpdateChecker(), dataState2, new PreviewButtonInputHandler(), new InformationMessageList()));
