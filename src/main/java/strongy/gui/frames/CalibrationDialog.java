...
import strongy.gui.components.layout.Divider;
import strongy.gui.components.layout.StackPanel;
import strongy.gui.options.Histogram;
...
import strongy.model.datastate.calibrator.Calibrator;
...
public class CalibrationDialog extends ThemedDialog {
	...
	final StrongyPreferences preferences;
	final JFrame owner;
	...
	public CalibrationDialog(StyleManager styleManager, StrongyPreferences preferences, ICalibratorFactory calibratorFactory, IActionExecutor actionExecutor, JFrame owner, boolean isManualCalibrator) {
	...
	private static boolean isBoatCalibrator(StrongyPreferences preferences) {
		return preferences.usePreciseAngle.get();
	}

	private static String getTitle(StrongyPreferences preferences, boolean isManualCalibrator) {
		if (isBoatCalibrator(preferences))
