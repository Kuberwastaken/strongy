...
public abstract class Theme {
	...
	public static void loadThemes(StrongyPreferences preferences) {
		dark = new DarkTheme();
	...
	private static void loadCustomThemes(StrongyPreferences preferences) {
	...
	private static void addCustomTheme(CustomTheme theme, StrongyPreferences preferences) {
		Assert.isFalse(THEMES.containsKey(theme.UID));
		nextCustomThemeUID--;
		THEMES.put(theme.UID, theme);
	...
	private static void serializeCustomThemes(StrongyPreferences preferences) {
	...
	public static void createCustomTheme(StrongyPreferences preferences) {
	...
	public static void deleteCustomTheme(StyleManager styleManager, StrongyPreferences preferences, CustomTheme theme) {
