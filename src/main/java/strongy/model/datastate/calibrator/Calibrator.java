...
import strongy.model.datastate.endereye.ManualEnderEyeThrow;
...
public class Calibrator implements IDisposable {
	...
	public Calibrator(CalculatorSettings calculatorSettings, IPlayerPositionInputSource playerPositionInputSource, StrongyPreferences preferences, boolean isBoatThrowCalibrator, boolean isManualCalibrator) {
		try {
