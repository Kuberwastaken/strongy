...
import strongy.model.datastate.endereye.EnderEyeThrow;
...
public class BoatEnderEyeThrow extends EnderEyeThrow {
	...
	public BoatEnderEyeThrow(IPlayerPosition playerPosition, StrongyPreferences preferences, float boatAngle) {
	...
	public BoatEnderEyeThrow(IDetailedPlayerPosition detailedPlayerPosition, StrongyPreferences preferences, float boatAngle) {
