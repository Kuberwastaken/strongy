...
import strongy.io.savestate.IFileAccessor;
...
public class DomainModelImportExportService {
	...
	public DomainModelImportExportService(IDomainModel domainModel, IFileAccessor fileAccessor, StrongyPreferences preferences) {
