...
import strongy.model.actions.alladvancements.SetAllAdvancementsGeneralLocationAction;
...
public class F3ILocationInputHandler implements IDisposable {
	...
	public F3ILocationInputHandler(IF3ILocationInputSource f3iLocationInputSource, IDataState dataState, IActionExecutor actionExecutor, StrongyPreferences preferences) {
