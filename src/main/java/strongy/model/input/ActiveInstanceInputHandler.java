...
public class ActiveInstanceInputHandler implements IDisposable {
	...
	public ActiveInstanceInputHandler(IActiveInstanceProvider activeInstanceProvider, IDomainModel domainModel, IDataState dataState, IActionExecutor actionExecutor, StrongyPreferences preferences) {
