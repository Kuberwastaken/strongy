...
import strongy.io.mcinstance.MinecraftWorldFile;
...
import strongy.util.FakeActiveInstanceProvider;
...
class ActiveInstanceInputHandlerTest {
	...
	void changingMinecraftWorldExecutesResetAction(boolean preferenceEnabled) {
		// Arrange
		StrongyPreferences preferences = new StrongyPreferences(new UnsavedPreferences());
